<x-layouts.tenant :title="'Import allievi CSV — '.tenant('id')">
    <x-ui.page>
        <x-ui.page-header title="Import da CSV" subtitle="File UTF-8 con intestazione sulla prima riga.">
            <x-slot:breadcrumb>
                <a href="{{ route('tenant.admin.learners.index') }}" class="link link-hover">Allievi</a>
        ...
        <div class="space-y-0 border-b border-base-300">
            ...
            <div class="px-4 py-6 lg:px-6">
                <form method="post" action="{{ route('tenant.admin.learners.import.store') }}" enctype="multipart/form-data" class="mx-auto max-w-2xl space-y-5">
                    @csrf
