<x-layouts.tenant :title="'Profilo organizzazione — Admin'">
    <div class="mx-auto max-w-[840px] px-6 py-10">
        @if (session('toast'))
            <x-ui.alert type="success" dismiss="3000" class="mb-6">
                {{ session('toast') }}
            </x-ui.alert>
        @endif

        <div class="mb-6">
            <h1 class="text-2xl font-bold tracking-tight">Impostazioni organizzazione</h1>
            <p class="mt-2 text-xs text-base-content/60">
                Slug identificativo: <span class="font-mono">{{ tenant('id') }}</span>
            </p>
        </div>
        ...
        <div class="space-y-10 mt-6">
                    ...
                    <div class="mt-6 grid gap-8 lg:grid-cols-2">
                            ...
                            <div class="form-control w-full">
                                ...
                                <div class="mt-2 flex items-center gap-3">
                                    <input id="pdf_report_accent_picker" type="color"
                                           class="h-10 w-12 cursor-pointer rounded-lg border border-base-300 bg-base-200 p-1"
                                           value="{{ $initialAccent }}"
                        ...
                        <div class="card bg-base-100 border border-base-300">
                            <div class="card-body p-5">
                                ...
                                <div id="pdf_preview"
                                     class="mt-4 overflow-hidden rounded-xl border border-base-300 bg-white text-slate-900 shadow-sm"
            ...
            <section class="card bg-base-100 shadow-xl">
                <div class="card-body">
                    ...
                    <p class="mt-1 text-sm text-base-content/70">Compare nell'intestazione per tutti gli utenti della tua organizzazione.</p>

                    <div class="mt-6 flex flex-col items-start gap-4 sm:flex-row sm:items-center">
                        <div class="flex h-16 w-16 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-primary/30 bg-primary/10">
                            @if ($logoUrl)
